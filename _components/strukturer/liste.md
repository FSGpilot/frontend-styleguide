---
permalink: /components/strukturer/liste/
layout: styleguide
type: component
title: Struktureret liste
category: UI components
subcategory: Strukturer (organismer)
lead: Strukturerede lister serve site visitors who arrive at the bottom of a page without finding what they want.
subnav:
- text: Big footer
  href: '#big-footer'
- text: Medium footer
