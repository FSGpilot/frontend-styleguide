...
<p>Body tekst om ikontaksonomien og lidt om kategorierne.</p>
...
<div class="accordion-bordered">
  <button class="button-unstyled accordion-button"
    aria-expanded="false" aria-controls="icons-docs">
    Brugervenlighed
  </button>
  <div id="icons-docs" class="accordion-content">
   Tekst om ikke at overbruge ikoner og om værdien af konsistens og kohærens på tværs af det offentlige.
  </div>
</div>
