...
<div class="container">
    ...
    <p class="mt-6">Add the `accordion-bordered` class to your `.accordion` to enable the visual
        border.:</p>
    ...
    <p class="mt-6">You can allow multiple sections to remain open at the same time by adding
        the `aria-multiselectable="true"` attribute to your `.accordion`. context:
    </p>
