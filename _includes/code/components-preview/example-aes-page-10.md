...
<main class="container page-container">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <p class="mb-4">Hvis du ønsker dokumentation på fremsendelse kan du downloade anmodningen.</p>
            ...
            <p>Sagens parter vil indenfor 7 hverdage modtage en kvittering med
                journalnummer og oplysninger om, hvornår AES forventer at have
                en udtalelse klar.</p>
            ...
            <p>Gebyr: 6.220 kr. <br> Ved overførslen skal I oplyse skadelidtes
                CPR-nr.: 1702671913</p>
            <h2 class="h4">Ved spørgsmål eller supplerende oplysninger</h2>
            <p>Kontakt AES på aes@aes.dk eller 72 00 60 00 <br> Referencenummer:
                28346863</p>
            <button class="button button-secondary mt-7">Opret ny sag</button>
        </div>
    </div>
</main>
