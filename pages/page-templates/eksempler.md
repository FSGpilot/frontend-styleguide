...
<div class="row">
  ...
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
    <a href="{{ site.baseurl }}/pages/page-templates/aktindsigt/aktindsigt-2"><img src="{{ site.baseurl }}/img/examples_pages/aktindsigt.PNG" style="max-width: 100%; width: 1018px"></a>
  </div>
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
    <a href="{{ site.baseurl }}/pages/page-templates/aktindsigt/aktindsigt-3"><img src="{{ site.baseurl }}/img/examples_pages/aktindsigt.PNG" style="max-width: 100%; width: 1018px"></a>
  </div>
</div>
<div class="row mt-5">
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
...
<a class="button button-secondary mt-5" href="{{ site.baseurl }}/pages/page-templates/aes/aes1">Demo erstatningssag</a>
...
<div class="row">
  ...
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
    <a href="{{ site.baseurl }}/pages/page-templates/digital-flytning/flytning-2"><img src="{{ site.baseurl }}/img/examples_pages/digital-flytning.PNG" style="max-width: 100%; width: 1018px"></a>
  </div>
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
   <a href="{{ site.baseurl }}/pages/page-templates/digital-flytning/flytning-3"><img src="{{ site.baseurl }}/img/examples_pages/digital-flytning.PNG" style="max-width: 100%; width: 1018px"></a>
  </div>
</div>
<div class="row mt-5">
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
    <a href="{{ site.baseurl }}/pages/page-templates/digital-flytning/flytning-4"><img src="{{ site.baseurl }}/img/examples_pages/digital-flytning.PNG" style="max-width: 100%; width: 1018px"></a>
  </div>
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
    <a href="{{ site.baseurl }}/pages/page-templates/digital-flytning/flytning-5"><img src="{{ site.baseurl }}/img/examples_pages/digital-flytning.PNG" style="max-width: 100%; width: 1018px"></a>
  </div>
</div>
