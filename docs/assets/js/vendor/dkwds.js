...
var jsSelector = '.js-calendar-group';
...
var datepickerGroup = function () {
  ...
  _createClass(datepickerGroup, [{
    key: 'initDatepicker',
    value: function initDatepicker(el, dayEl, monthEl, yearEl) {
...
module.exports = behavior({}, {
  init: function init(target) {
    forEach(select(jsSelector), function (calendarGroupElement) {
      new datepickerGroup(calendarGroupElement);
    });
  }
});

},{"../../vendor/pikaday.js":39,"../utils/behavior":32,"../utils/select":34,"../utils/toggle":37,"array-foreach":2}],20:[function(require,module,exports){
'use strict';
...
},{"./accordion":17,"./banner":18,"./datepicker":19,"./footer":20,"./navigation":22,"./password":23,"./search":24,"./skipnav":25,"./validator":26}],22:[function(require,module,exports){
'use strict';
...
},{"./components":21,"./config":27,"./polyfills":31,"domready":5}],29:[function(require,module,exports){
'use strict';
